...
if (isset($_POST['del-btn']))
{
    $id = $_GET['id'];
    $user->delete();
    header("Location: delete.peserta.php?deleted");
}
...
<?php
    if (isset($_GET['id'])) {
        ...
        echo"<a href='view.peserta.php' class='btn btn-large btn-success'><span class='glyphicon glyphicon-backward'></span> Home </a>";
     }
?>
